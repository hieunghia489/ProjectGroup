...
public class ItemController extends HttpServlet {
    private final String ERROR_PAGE = "bill.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(request.getSession().getAttribute("STAFF") != null){
                ...
                ArrayList<ItemDTO> dto = dao.getAllItemByIsKeep(pdto.getStoreID());
                
                if (dto != null) {
                    request.setAttribute("ALLITEM", dto);                   
                    url = ITEM_PAGE;
                }                
            }        
        }
        catch(Exception e){
            log("Error at ItemController " + e.getMessage());
        }
        finally{
