<%-- 
    Document   : item_return
    Created on : Jul 30, 2022, 9:33:10 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Danh sách đồ đã thanh toán</title>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <%
                                            ArrayList<ItemDTO> itemList = (ArrayList<ItemDTO>) request.getAttribute("ITEMRETURN");
                                            if (itemList != null) {
                                        %>
                                        <table class="table table-striped table-bordered zero-configuration text-center">
                                            ...
                                            <form action="ItemListController">
                                                <tr>
                                                    ...
                                                    <td><% if(item.isStatusID() == false){out.print("Đã hoàn trả");}%></td>
                                                </tr>
                                            </form>
                                            <% } %>
                                            </tbody>
