<%-- 
    ...
    Created on : Aug 2, 2022, 2:45:54 PM
    Author     : Admin
--%>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id ="header_title_table">
                                        <h4 class="card-title">Thông tin khách hàng cũ</h4>
                                    </div>
                                    <div class="table-responsive">
                                        <%
                                            ArrayList<CustomerDTO> cusList = (ArrayList<CustomerDTO>) request.getAttribute("LISTOLDCUS");
                                            if (cusList != null) {
                                        %>
                                        ...
                                        <div style="text-align: center;">
                                            <button>
                                                <a href="ListCustomerController" style="text-decoration: none;">Quay lại</a>
                                            </button>
                                        </div>
                                    </div>
                                </div>
